...
--
-- Host: localhost:3306
-- Generation Time: Sep 02, 2024 at 11:19 PM
...
CREATE TABLE `member` (
  `member_id` int NOT NULL,
  `member_last` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `member_first` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `member_rank` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `member_salut` varchar(30) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `dept_code` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `designation_id` int DEFAULT NULL,
  `program_code` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
(27, 'Admin', 'Admin', 'Assistant Professor I', 'Mrs', 'CIT', 66, '', 'admincit', 'admin', 'admin'),
(177, 'Rizal', 'Jose', 'Assistant Professor I', 'Dr', 'CAS', 66, '', 'josecas', 'rizal', 'admin'),
(178, 'Hamzah', 'Tajudeen', 'Professor I', 'Dr', 'CAS', 67, NULL, 'tajudeencas', 'hamzah', 'admin');
...
CREATE TABLE `schedule` (
  ...
  `day` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `member_id` int DEFAULT NULL,
  `subject_code` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `cys` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `room` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `remarks` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `settings_id` int DEFAULT NULL,
  `encoded_by` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
(9, 7, 'm', 178, 'Further maths', 'BSED 1A', '103', '', 12, '27'),
(10, 8, 'm', 178, 'Further maths', 'BSED 1A', '103', '', 12, '27'),
(11, 14, 'm', 178, 'Further maths', 'BSED 1A', '103', '', 12, '27'),
(12, 12, 'w', 27, 'ALG', 'BEED 1A', '101', '', 12, '27'),
(13, 15, 'w', 27, 'ALG', 'BEED 1A', '101', '', 12, '27'),
(14, 11, 'f', 27, 'ALG', 'BEED 1A', '101', '', 12, '27'),
(15, 15, 'f', 27, 'ALG', 'BEED 1A', '101', '', 12, '27'),
(16, 11, 'f', 27, 'ALG', 'BEED 1A', '101', '', 12, '27'),
(17, 15, 'f', 27, 'ALG', 'BEED 1A', '101', '', 12, '27'),
(18, 11, 'f', 27, 'ALG', 'BEED 1A', '101', '', 12, '27'),
(19, 15, 'f', 27, 'ALG', 'BEED 1A', '101', '', 12, '27'),
(20, 11, 'f', 27, 'ALG', 'BEED 1A', '101', '', 12, '27'),
(21, 15, 'f', 27, 'ALG', 'BEED 1A', '101', '', 12, '27'),
(22, 23, 't', 27, 'ALG', 'BEED 1A', '101', '', 12, '27'),
(23, 24, 't', 27, 'ALG', 'BEED 1A', '101', '', 12, '27'),
(24, 23, 'th', 27, 'ALG', 'BEED 1A', '101', '', 12, '27');
...
--
ALTER TABLE `cys`
  MODIFY `cys_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `designation`
  MODIFY `designation_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
...
--
ALTER TABLE `member`
  MODIFY `member_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=179;

--
-- AUTO_INCREMENT for table `program`
--
ALTER TABLE `program`
  MODIFY `prog_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `rank`
--
ALTER TABLE `rank`
  MODIFY `rank_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `salut`
  MODIFY `salut_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `schedule`
--
ALTER TABLE `schedule`
  MODIFY `sched_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `settings`
--
ALTER TABLE `settings`
  MODIFY `settings_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `sy`
  MODIFY `sy_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `time`
--
ALTER TABLE `time`
  MODIFY `time_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
