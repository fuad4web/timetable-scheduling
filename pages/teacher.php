...
<html>
  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
    ...
    <?php
        ...
        $query=mysqli_query($con,"select * from member left outer join designation on member.designation_id=designation.designation_id order by member_last");
						   ...
						   <div class="form-group">
							<label for="date">Rank</label>
								...
								<select class="form-control select2" name="rank" required>
								  <?php 
									$rankQuery=mysqli_query($con,"select * from `rank` order by rank_id")or die(mysqli_error($con));
