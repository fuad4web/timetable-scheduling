    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
	      ...
	      <div class="col-md-8">
              <div class="box box-warning">
                   ...
                   <a href="#examt" data-target="#examt" data-toggle="modal" class="dropdown-toggle pull-right">
                    ...
                    <span style="font-size:18px;font-weight:bolder" class="pull-right">Print Exam Schedule &nbsp;</span><br><br>
		...
		<?php
				...
				$query=mysqli_query($con,"select * from time where days='fst' order by time_start")or die(mysqli_error($con));
		...
		<?php }?>					  
            ...
            <div class="col-md-4">
              <div class="box box-warning">
               <?php
               	$query=mysqli_query($con,"select * from exam_sched natural join member where sched_id='$sched_id'")or die(mysqli_error($con));
